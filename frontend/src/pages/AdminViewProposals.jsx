...
const AdminViewProposals = () => {
    ...
    const fetchPropostas = async (empresaId = '') => {
        ...
        try {
            ...
            if (err.response?.status === 401 || err.response?.status === 403) {
                ...
                setError('Erro ao carregar propostas: ' + (err.response?.data?.message || err.message));
            }
        } finally {
            setLoading(false);
        }
    ...
    // ADICIONAR FUNÇÃO PARA EDITAR PROPOSTA
    const handleEditProposal = (proposalId) => {
        navigate(`/admin/editar-proposta/${proposalId}`);
    };
    ...
    return (
        <div className="d-flex"> {/* CORRIGIDO: removido o hífen */}
            <Sidebar />
            <div className="flex-grow-1 p-4"> {/* CORRIGIDO: melhor estrutura de layout */}
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    {proposta.criador?.DepartmentProfile?.departamento ? (
                                                        <p><strong>Departamento:</strong> {proposta.criador.DepartmentProfile.departamento}</p>
                                                    ) : (
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <p><strong>Contrato:</strong> {proposta.tipo_contrato || 'N/A'}</p>
                                            ...
                                            <div className="d-flex gap-2 mt-3 flex-wrap">
                                                ...
                                                {proposta.estado === 'ativa' && (
                                                    ...
                                                    >
                                                        <i className="bi bi-pause-circle"></i> Desativar
                                                    </button>
                                                )}
